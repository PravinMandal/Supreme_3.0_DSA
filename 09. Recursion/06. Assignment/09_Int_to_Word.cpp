...
int main() {
    ...
    // Hardcoded testcases
    cout << "123 -> " << sol.numberToWords(123) << endl;
    cout << "12345 -> " << sol.numberToWords(12345) << endl;
    cout << "1234567 -> " << sol.numberToWords(1234567) << endl;
    cout << "1000000 -> " << sol.numberToWords(1000000) << endl;
    cout << "0 -> " << sol.numberToWords(0) << endl;
